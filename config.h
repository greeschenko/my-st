 ...
 */
static char font[] = "Droid Sans Mono Slashed for Powerline:pixelsize=13:antialias=true:autohint=false";
...
static unsigned int doubleclicktimeout = 150;
...
static const char *colorname[] = {
	...
	"#cccccc",
	"#555555",
    "#001e2c", // 258 background
    "#bbcadc", // 259 foreground
};
